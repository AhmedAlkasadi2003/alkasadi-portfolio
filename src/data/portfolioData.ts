...
export const WORK_EXPERIENCES: ExperienceItem[] = [
  {
    ...
    location: 'Hadramout, Yemen',
    locationAr: 'حضرموت، اليمن',
    description: ['Worked as a freelancer at Quarisma, designing new projects and developing front-end interfaces using React.'],
    descriptionAr: ['عملت كمطور مستقل في Quarisma، حيث صممت مشاريع جديدة وطوّرت واجهات أمامية باستخدام React.'],
    keyWins: ['Freelance project design', 'React front-end development'],
    keyWinsAr: ['تصميم مشاريع مستقلة', 'تطوير واجهات أمامية باستخدام React'],
    technologies: ['React'],
  },
  {
    id: 'alphabet',
    ...
    location: 'Hadramout, Yemen',
    locationAr: 'حضرموت، اليمن',
    description: ['Worked as a full-time employee at Alphabet, designing new projects and developing APIs using Tailwind CSS and React.'],
    descriptionAr: ['عملت بدوام كامل في Alphabet، حيث صممت مشاريع جديدة وطوّرت واجهات برمجية باستخدام Tailwind CSS وReact.'],
    keyWins: ['Full-time project design', 'API development with React and Tailwind CSS'],
    keyWinsAr: ['تصميم مشاريع بدوام كامل', 'تطوير واجهات برمجية باستخدام React وTailwind CSS'],
  ...
  },
  {
    ...
    location: 'Hadramout, Yemen',
    locationAr: 'حضرموت، اليمن',
    description: ['Worked as a full-time employee at New Dimensions Company, designing new projects and developing APIs using Tailwind CSS and Next.js.'],
    descriptionAr: ['عملت بدوام كامل في شركة الأبعاد الجديدة، حيث صممت مشاريع جديدة وطوّرت واجهات برمجية باستخدام Tailwind CSS وNext.js.'],
    keyWins: ['Full-time project design', 'API development with Next.js and Tailwind CSS'],
    keyWinsAr: ['تصميم مشاريع بدوام كامل', 'تطوير واجهات برمجية باستخدام Next.js وTailwind CSS'],
